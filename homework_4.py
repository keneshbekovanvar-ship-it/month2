class Contact:
    def __init__(self, name: str, phone_number: str):
        """Class describing a single contact."""
        self.name = name
...
class ContactList:
    """Container for storing contacts."""
    ...
    def add_contact(cls, name: str, phone_number: str):
        ...
        if not Contact.validate_phone_number(phone_number):
            raise ValueError(
                f"Invalid phone number: {phone_number}. Must contain exactly 10 digits."
            )
...
if __name__ == "__main__":
    ...
    ContactList.add_contact("Ислам", "1234567890")
    ContactList.add_contact("Айдар", "0987654321")
